    ...
    <header className="max-w-[1440px] mx-auto px-4 py-4 relative flex justify-between items-center lg:px-6 lg:py-7">
      ...
      <div className="flex items-center">
        <nav
          ...
          } bg-white px-4 pb-[1.2rem] w-full lg:p-0 lg:w-fit lg:flex lg:items-center lg:space-y-0 lg:gap-[4rem]`}
        >
            ...
            {navLinks.map((link) => {
              ...
              return (
                <li key={id}>
                  <Link
                    to={href}
                    className="font-medium text-[1.1rem] text-gray-700"
                  >
                    {label}
                  </Link>
                </li>
          ...
          <Link
            to={"/login"}
            className="inline-block bg-[#0099ff] px-[2.2rem] py-[0.7rem] lg:px-[2.8rem] lg:py-[0.9rem] rounded-[20px] text-white text-[1.2rem] font-bold hover:opacity-80"
          >
            Login
          </Link>
        </nav>
